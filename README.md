...
* **Backend & Runtimes:** Node.js, NestJS, TypeScript, Fastify, Bun, Prisma ORM, Zod, Oracle Service Bus (OSB 12c), WebLogic 12c.
* **Integration & E-Commerce:** Headless Commerce (Medusa.js pattern), Omnichannel CRM, API Gateways, REST/GraphQL, SOAP/WSDL/XML.
* **Infrastructure & DevOps:** AWS, LocalStack, Docker Compose, NGINX, Cloudflare, Linux.
